...
const AllProject = () => {
    ...
    return (
        <div className="p-6 min-h-screen font-sans max-w-7xl mx-auto">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {currentEntries.map((project) => (
                                    <tr key={project._id} className="hover:bg-gray-50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getProjectTypeBadgeColor(project.category)}`}>
            ...
            {/* View Project Modal - Complete Version */}
                    ...
                    <div className="bg-white rounded-2xl shadow-xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="border-b border-gray-200 pb-4">
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Submitted on {formatDate(selectedProject.createdAt)} | 
                                    Project ID: {selectedProject._id?.slice(-8)}
                                </p>
                            </div>
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-5">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="text-gray-900 mt-1">{selectedProject.category || 'Not specified'}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-900 mt-1">{selectedProject.year || 'Not specified'}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div className="md:col-span-2">
                                        <label className="text-xs font-medium text-gray-500 uppercase">Description / Synopsis</label>
                                        <p className="text-gray-700 text-sm mt-1 leading-relaxed">{selectedProject.description || 'Not provided'}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-5">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-900 mt-1">{selectedProject.aspectRatio || 'Not specified'}</p>
                                    </div>
                                    <div>
                                        <label className="text-xs font-medium text-gray-500 uppercase">Film Color</label>
                                        <p className="text-gray-900 mt-1">{selectedProject.filmColor || 'Not specified'}</p>
                                    </div>
                                    <div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-5">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="text-gray-900 mt-1">{selectedProject.submitterEmail || selectedProject.email || 'Not provided'}</p>
                                    </div>
                                    <div>
                                        <label className="text-xs font-medium text-gray-500 uppercase">Phone</label>
                                        <p className="text-gray-900 mt-1">{selectedProject.submitterPhone || selectedProject.phone || 'Not provided'}</p>
                                    </div>
                                    <div>
                                        <label className="text-xs font-medium text-gray-500 uppercase">Country</label>
                                        <p className="text-gray-900 mt-1">{selectedProject.submitterCountry || selectedProject.country || 'Not provided'}</p>
                                    </div>
                                    <div>
                                        <label className="text-xs font-medium text-gray-500 uppercase">City</label>
                                        <p className="text-gray-900 mt-1">{selectedProject.submitterCity || selectedProject.city || 'Not provided'}</p>
                                    </div>
                                    <div className="md:col-span-2">
                                        <label className="text-xs font-medium text-gray-500 uppercase">Address</label>
                                        <p className="text-gray-900 mt-1">{selectedProject.submitterAddress || selectedProject.address || 'Not provided'}</p>
                                    </div>
                                </div>
                            </div>
